...
public class AllOrders extends BaseFragment {
    ...
    private void getOtherOrders() {
        try {
            showLoading();
            String url = BuildConfig.BASE_URL_INR + "GetINRDealsTransaction?LoginId=" + PreferencesManager.getInstance(context).getUSERID() + "&Page=" + Cons.encryptMsg(pageNo + "", cross_intent);
            ...
            call.enqueue(new Callback<JsonObject>() {
                ...
                public void onResponse(@NonNull Call<JsonObject> call, @NonNull Response<JsonObject> response) {
                    hideLoading();
                    LoggerUtil.logItem("ALL- " + response.body());
                    try {
