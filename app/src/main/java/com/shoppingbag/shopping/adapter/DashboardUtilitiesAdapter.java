...
public class DashboardUtilitiesAdapter extends RecyclerView.Adapter<DashboardUtilitiesAdapter.ViewHolder> {
    ...
    public DashboardUtilitiesAdapter(Context context, List<TravelItem> list, MvpView mvp) {
        mContext = context;
        itemList = list;
        this.mvp = mvp;
    }
...
//        TextView androidGridviewText;
        ...
        ViewHolder(View view) {
            ...
            androidCustomGridviewLayout.setOnClickListener(v -> mvp.getClickPositionDirectMember(getAdapterPosition(), itemList.get(getAdapterPosition()).getLink()
