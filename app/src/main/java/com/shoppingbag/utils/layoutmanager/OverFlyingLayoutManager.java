package com.shoppingbag.utils.layoutmanager;
...
public class OverFlyingLayoutManager extends RecyclerView.LayoutManager
    ...
    /**
     * Calculates the view layout order_adapter. (e.g. from end to start or start to end)
    ...
    /**
     * Used to reverse item traversal and layout order_adapter.
